                ...
                <div className='d-flex justify-content-lg-start justify-content-center py-4'>
                  <form className="form-custom">
                    <label htmlFor="search">
                      <input className="input-custom" type="text" required="" placeholder="Search Blogs" id="search" />
              ...
              <div key={blog.id} className="col-md-6 col-lg-4 d-flex align-items-stretch mb-4">
                <div className="card w-100 d-flex flex-column">
                  ...
                  <div className="card-body text-light d-flex flex-column flex-grow-1">
                    ...
                    <Link to={`/blogdetail/${blog.id}`} className="btn-global text-center text-bg-primary-emphasis mt-auto">Read More</Link>
                  </div>
                </div>
              </div>
            ))}
            <div className="text-center">
              <button className='btn-global mt-lg-5'>LOAD MORE</button>
            </div>
          </div>
        </div>
